...
import { login, register } from 'slices/authenticationSlice'
import { checkCustomerExists } from '../../firebase/auth'
import OrderStatusModal from './OrderStatusModal'
import { setOtpError, clearOtpError } from 'slices/uiSlice'
                        ...
                        {loginScreen ?
                            <>
                                ...
                                <View style={{ width: '100%', alignItems: 'center' }}>
                                    ...
                                    >
                                        <Text style={[styles.code, isButtonDisabled && { color: 'rgba(255,255,255,0.15)', fontSize: 16, fontWeight: '600' }]}>Continue</Text>
                                    </TouchableOpacity>
                                </View>
                            ...
                            <>
                                ...
                                <View style={styles.dualButtonsContainer}>
                                    <View style={styles.dualButton}>
                                        <TouchableOpacity
                                            style={[styles.button, { backgroundColor: colors.bgLight }, !enableResend && styles.buttonDisabled]}
                                            onPress={() => {
                                                sendOtp(`+91${phoneNumber}`)
                                                otpInputRef.current?.blur()
                                            }}
                                        ...
                                        >
                                            <Text style={[styles.code, { fontSize: 16 }, !enableResend && { color: 'rgba(255,255,255,0.15)', fontSize: 16, fontWeight: '600' }]}>
                                                Resend OTP
                                            </Text>
                                        </TouchableOpacity>
                                        <Text style={styles.timerText}>
                                            {enableResend ? "" : `Please wait ${timer} seconds`}
                                        </Text>
                                    </View>
                                    <View style={styles.dualButton}>
                                        <TouchableOpacity
                                        ...
                                        >
                                            <Text style={[styles.code, { fontSize: 16 }, isOtpButtonDisabled && { color: 'rgba(255,255,255,0.5)' }]}>Get Started</Text>
                                        </TouchableOpacity>
                                    </View>
                                </View>
