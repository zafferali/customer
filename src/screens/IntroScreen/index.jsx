...
const IntroScreen = () => {
  ...
  const handleRegister = async () => {
    try {
      const customerDetails = { ...customer, name, email };
  ...
  return (
    <Layout title="Introduce yourself">
      <View style={GlobalStyles.lightBorder}>
        <CustomInput
          ...
          value={name}
        />
        <CustomInput label="*Phone Number" notEditable style={styles.input} value={customer.mobile} />
        <CustomInput
          label="Email Address"
